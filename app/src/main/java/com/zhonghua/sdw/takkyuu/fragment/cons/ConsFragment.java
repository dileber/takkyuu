package com.zhonghua.sdw.takkyuu.fragment.cons;
 ...
 * {@link ConsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ConsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConsFragment extends TakkyuuBaseFragment {
    ...
    @Override
    protected void show() {
        SFont sFont = setRightButtonFont(R.string.hand);
        setTitle(getResources().getString(R.string.takkyuu_cons));
